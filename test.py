...
if __name__ == "__main__":
    ...
    playsound("01_01_01_01_dogs-sitting_disgust.wav")
    time.sleep(2)
    filename="01_01_01_01_dogs-sitting_disgust.wav"
